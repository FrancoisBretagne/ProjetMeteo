...
int humidity(FILE* fichier, FILE* output_file, int Typedetri){//on prend en arguments le fichier d'entrée, le fichire de sortie et le type de tri qui vaut 1,2 ou 3 en fonction du choix du tri si c'est en tri ABR, liste chainée ou AVL
    int ligne=0,i=1;
    float key,val=0;
